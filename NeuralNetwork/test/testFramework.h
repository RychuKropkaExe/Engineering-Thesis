...
#define TEST_START                                                                \
  (LOG(ESSENTIAL_LOGS, INFO_TYPE, "Test: " << __FUNCTION__ << "\t\t  [STARTED]"), \
